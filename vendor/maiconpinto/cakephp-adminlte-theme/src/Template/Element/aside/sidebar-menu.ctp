...
<!--        </ul>-->
    ...
    <li class="treeview">
        <a href="#">
            ...
            <span class="label bg-orange pull-right">2</span>
        </a>
        <ul class="treeview-menu">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="<?php echo $this->Url->build('/addRd'); ?>"><i class="fa fa-circle-o"></i> Add RD</a></li>
            <li><a href="<?php echo $this->Url->build('/viewRdInformation'); ?>"><i class="fa fa-circle-o"></i> View RD</a></li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="<?php echo $this->Url->build('/viewFdInformation'); ?>"><i class="fa fa-circle-o"></i> View FD</a></li>
        </ul>
    </li>
    <li class="treeview">
        <!--        <a href="#">-->
        <a href="<?php echo $this->Url->build('/viewBatches'); ?>"><i class="fa fa-dashboard"></i> <span>View Batches</span></a> <!-- <i class="fa fa-angle-left pull-right"></i> -->
        <!--        </a>-->
        <!--        <ul class="treeview-menu">-->
        <!--            <li><a href="--><?php //echo $this->Url->build('/'); ?><!--"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>-->
        <!--            <li><a href="--><?php //echo $this->Url->build('/pages/home2'); ?><!--"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>-->
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="<?php echo $this->Url->build('/viewLoanPayment'); ?>"><i class="fa fa-circle-o"></i> View Loan payments</a></li>
        </ul>
    </li>
    <li class="treeview">
        <a href="#">
        ...
        <ul class="treeview-menu">
            <li><a href="<?php echo $this->Url->build('/users/users/change-password'); ?>"><i class="fa fa-circle-o"></i> Change Password</a></li>
            <li><a href="<?php echo $this->Url->build('/logout'); ?>"><i class="fa fa-circle-o"></i> Logout</a></li>
        </ul>
    </li>
<!--    <li class="treeview">-->
<!--        <a href="#">-->
