...
<!--            </li>-->
            ...
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <?php echo $this->Html->image('user_account_default.png', array('class' => 'user-image', 'alt' => 'User Image')); ?>
                    <span class="hidden-xs">Welcome, Admin</span>
                </a>
<!--                <ul class="dropdown-menu">-->
                    <!-- User image -->
<!--                    <li class="user-header">-->
<!--                        --><?php //echo $this->Html->image('user_account_default.png', array('class' => 'img-circle', 'alt' => 'User Image')); ?>
<!---->
<!--                        <p>-->
<!--                            Admin-->
